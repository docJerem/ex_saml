defmodule ExSaml.ErrorMessages do
  ...
  @flow_errors ~w(bad_saml bad_assertion bad_version bad_recipient bad_audience too_early stale_assertion duplicate invalid_response missing_saml_response idp_initiated_not_allowed invalid_target_url invalid_relay_state invalid_idp_id bad_issuer bad_in_response_to bad_subject_confirmation session_expired unknown_idp exception access_denied unknown_error)a
